...
export default class Trx extends React.Component {
  ...
  render() {
    ...
    if (!_.isNil(this.props.addSelectedTrx))
      plusBtn = <Icon className="trxAdd" type="plus-circle" onClick={e => this.props.addSelectedTrx(this.props.label)}/>;

    if (!_.isNil(this.props.removeSelectedTrx))
        minusBtn = <Icon className="trxRemove" type="minus-circle" onClick={e => this.props.removeSelectedTrx(this.props.index)}/>;
